...
public class OuttakeIOReal implements OuttakeIO{
    ...
    private void configOuttake(TalonFX talon)
    {
        ...
        //bottomOuttakeMotor.setControl(new Follower(topOuttakeMotor.getDeviceID(),true));
    ...
    public void updateInputs(OuttakeIOInputs inputs)
    {
        ...
        inputs.topSpeedPct = topOuttakeMotor.get();
        inputs.topRotationsPerSec = topOuttakeMotor.getVelocity().getValue()/60;
        inputs.topAppliedVolts = topOuttakeMotor.getDutyCycle().getValue()/2*topOuttakeMotor.getSupplyVoltage().getValue();
        ...
        inputs.bottomSpeedPct = bottomOuttakeMotor.get();
        inputs.bottomRotationsPerSec = bottomOuttakeMotor.getVelocity().getValue()/60;
        inputs.bottomAppliedVolts = bottomOuttakeMotor.getDutyCycle().getValue()/2*bottomOuttakeMotor.getSupplyVoltage().getValue();
        ...
        inputs.outtakeIsAlive = (bottomOuttakeMotor.isAlive()||topOuttakeMotor.isAlive()); //these will def be the same but
    ...
    @Override
    public void setOuttakePct(double desiredTopVelocityPct, double desiredBottomVelocityPct)
    {
