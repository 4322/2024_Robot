...
public class IntakeDeployer extends SubsystemBase implements IntakeDeployerIO {
    ...
    public void deploy() {
        if (Constants.intakeEnabled && initialized) {
            ...
            Logger.recordOutput(IntakeDeployerConstants.Logging.key + "DeployTargetRotations",
    ...
    public boolean isAtPosition() {
        return OrangeMath.equalToEpsilon(inputs.deployRotations, deployTarget, IntakeDeployerConstants.Deploy.toleranceRotations);
    }
