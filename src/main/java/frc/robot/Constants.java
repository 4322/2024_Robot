...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final class Auto {
      ...
      // max rotate speed not tested can/should be adjusted with testing
      public static final double autoMaxRotateSpeedMetersPerSecond = 
          0.75 * DriveConstants.maxRotationSpeedRadSecond;
      ...
      // acceleration based of of MaxVel / 2pi * r.
      public static final double autoMaxAngularAccelerationPerSec2 = 
           autoMaxAccelerationMetersPerSec2 / 2 * Math.PI * distWheelMetersR;
