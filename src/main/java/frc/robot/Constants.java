...
public final class Constants {
  ...
  public static final boolean autoRotateDebug = true;
  ...
  public static final class OuttakeConstants {
    ...
    public static final double ampPivotRotations = 55.0;
    public static final double ampBottomShooterRPS = 37.0;
  ...
  public static final class TunnelConstants {
    ...
    public static final double rewindVoltage =
        -2.5; // just enough to pull the note off the outtake wheels
    ...
    public static final double rewindSec = 0.08;
